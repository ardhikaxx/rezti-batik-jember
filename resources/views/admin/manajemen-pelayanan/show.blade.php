...
<div class="row">
    <div class="col-lg-8">
        <div class="card shadow-sm mb-4">
            <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
                ...
                <span class="badge bg-{{ $booking->status == 'pending' ? 'warning' : ($booking->status == 'confirmed' ? 'primary' : ($booking->status == 'completed' ? 'success' : 'secondary')) }}">
            ...
            <div class="card-body">
                <div class="row mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <p class="mb-1"><strong>Harga per Orang:</strong> Rp {{ number_format($booking->price_per_person, 0, ',', '.') }}</p>
                        <p class="mb-1"><strong>Total:</strong> Rp {{ number_format($booking->total_price, 0, ',', '.') }}</p>
                        <p class="mb-1"><strong>Metode Pembayaran:</strong> {{ ucfirst(str_replace('_', ' ', $booking->payment_method)) }}</p>
                    </div>
                </div>
    ...
    <div class="col-lg-4">
        <div class="card shadow-sm mb-4">
            ...
            <div class="card-body text-center">
                @if($booking->payment_proof)
                    <img src="{{ $booking->payment_proof_url }}" alt="Bukti Pembayaran" class="img-fluid mb-3" style="max-height: 200px;">
        ...
        <div class="card shadow-sm mt-4">
            ...
            <div class="card-body text-center">
                <a href="https://wa.me/{{ $booking->pembeli->no_hp }}" target="_blank" class="btn btn-success w-100">
