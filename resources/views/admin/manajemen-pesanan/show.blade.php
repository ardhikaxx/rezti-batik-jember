    ...
    <div class="col-lg-4">
        <div class="card shadow-sm mb-4">
            ...
            <div class="card-body">
                ...
                <p class="mb-1">{{ $order->shippingAddress->district }}, {{ $order->shippingAddress->city }}, {{ $order->shippingAddress->province }}</p>
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body text-center">
                @if($order->payment_proof)
                    <img src="{{ $order->payment_proof_url }}" alt="Bukti Pembayaran" class="img-fluid mb-3" style="max-height: 200px;">
