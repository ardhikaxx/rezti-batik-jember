        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    ...
                    <h4 class="small font-weight-bold">Produk Aktif <span class="float-right">{{ $activeProducts }}</span>
                    </h4>
                    <div class="progress mb-4">
                        <div class="progress-bar bg-info" role="progressbar"
                            style="width: {{ $totalProducts > 0 ? ($activeProducts / $totalProducts) * 100 : 0 }}%"
                            aria-valuenow="{{ $activeProducts }}" aria-valuemin="0" aria-valuemax="{{ $totalProducts }}">
                        </div>
                    </div>
                    <h4 class="small font-weight-bold">Produk Habis <span
                            class="float-right">{{ $outOfStockProducts }}</span></h4>
                    <div class="progress mb-4">
                        <div class="progress-bar bg-warning" role="progressbar"
                            style="width: {{ $totalProducts > 0 ? ($outOfStockProducts / $totalProducts) * 100 : 0 }}%"
                            aria-valuenow="{{ $outOfStockProducts }}" aria-valuemin="0"
                            aria-valuemax="{{ $totalProducts }}"></div>
                    </div>
                </div>
            </div>
        </div>
