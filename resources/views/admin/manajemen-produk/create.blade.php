...
@section('page-title', 'Tambah Produk Batik')
...
@section('content')
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-white border-0 py-3">
            <h6 class="m-0 fw-bold">Form Tambah Produk</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.data-barang.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
