                        ...
                        <form method="POST" action="{{ route('admin.login.submit') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" class="form-control password-input @error('password') is-invalid @enderror" id="password" name="password" required autocomplete="current-password">
