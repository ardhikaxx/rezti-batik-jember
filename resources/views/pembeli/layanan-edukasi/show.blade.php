    ...
    <div class="d-flex justify-content-between align-items-center mb-5">
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('pembeli.layanan-edukasi.index') }}">Booking Saya</a></li>
                    <li class="breadcrumb-item active" aria-current="page">#{{ str_pad($booking->id, 6, '0', STR_PAD_LEFT) }}</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value">
                            <a href="{{ $booking->payment_proof_url }}" target="_blank" class="btn btn-sm btn-outline-primary">
