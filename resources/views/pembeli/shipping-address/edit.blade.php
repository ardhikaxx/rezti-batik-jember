...
@section('content')
    <style>
        ...
        .form-switch .form-check-input:focus {
            background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='3' fill='%23B68D65'/%3e%3c/svg%3e");
        }
            ...
            <div class="col-lg-8">
                <div class="card shadow-lg border-0 rounded-4" style="border-color: var(--secondary-color) !important;">
                    <div class="card-header py-3"
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="mb-0 fw-bold text-white">
                                <i class="fas fa-edit me-2"></i>Edit Alamat Pengiriman
                            </h4>
                            <a href="{{ route('pembeli.shipping-address.index') }}" class="btn btn-sm"
                    ...
                    <div class="card-body" style="background-color: var(--light-color);">
                        <form method="POST" action="{{ route('pembeli.shipping-address.update', $shippingAddress->id) }}"
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control @error('recipient_name') is-invalid @enderror"
                                        ...
                                        value="{{ old('recipient_name', $shippingAddress->recipient_name) }}" required>
                            ...
                            <div class="row g-3 mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="district" name="district"
                                        value="{{ old('district', $shippingAddress->district) }}">
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="form-check form-switch mb-4">
                                <input class="form-check-input" type="checkbox" role="switch" id="is_default"
                                    name="is_default" value="1" {{ $shippingAddress->is_default ? 'checked' : '' }}>
